...
map.getView().fit([-13842100.416667, 2637155.000000, -7495487.083333, 6606328.333333], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Contaminants Across the US Associated with Congenital Cardiac Defects</h2>';
        return titleElement;
    })(),
