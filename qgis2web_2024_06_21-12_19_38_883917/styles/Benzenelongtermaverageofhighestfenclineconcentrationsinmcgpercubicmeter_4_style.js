...
var style_Benzenelongtermaverageofhighestfenclineconcentrationsinmcgpercubicmeter_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Amount (mcg)");
    var labelText = "";
    size = 0;
    ...
    if (value >= 3.040000 && value <= 4.384000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 3.0 + size, points: 3,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.384000 && value <= 5.988000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 3.0 + size, points: 3,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5.988000 && value <= 7.844000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 3.0 + size, points: 3,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 7.844000 && value <= 10.946000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 3.0 + size, points: 3,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10.946000 && value <= 63.070000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 3.0 + size, points: 3,
